...
export function LiveStatusCard() {
  ...
  return (
    <section className="flex h-48 flex-col overflow-hidden rounded-[32px] border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <div className="flex min-h-0 flex-1 items-center gap-4 rounded-2xl bg-[#F8F9FE] p-4">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#E9E6FF] text-[#5B4CF2] shadow-sm">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-end gap-1.5">
            ...
            <span className="mb-4 text-xl font-bold text-[#5B4CF2]">:</span>
...
function TimeBlock({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <span className="text-2xl font-bold tracking-wider text-[#1F1543]">{value}</span>
